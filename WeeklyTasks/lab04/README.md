...
## Features CHANGES By Tomas
- Changed min_edge_cost from 10.0 to 1.0 in box_world.py
- Uncommented diagonal edge code in box_world.py
- Selected the active heuristic top _hypot() instead of _manhattan()
  - The Euchildean distance is better for diagonal movement estimates.
